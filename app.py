...
embedding_model_name = "gemini-embedding-1.5" # Or a suitable Gemini embedding model
...
if uploaded_file:
    with st.spinner("Processing PDF..."):
        ...
        if kb:
            ...
            st.session_state.knowledge_base = kb # Store the knowledge base in session state
        else:
